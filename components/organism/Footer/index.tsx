            ...
            <div className="col-lg-8 mt-lg-0 mt-20">
              <div className="row gap-sm-0">
                ...
                <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                  ...
                  <ul className="list-unstyled">
                    <FooterItem title="hi@store.gg" href="mailto: hi@store.gg" />
                    <FooterItem title="team@store.gg" href="mailto: hteam@store.gg" />
                    <FooterItem title="Pasific 12, Jakarta Selatan" href="http://maps.google.com/?q=Pasific 12, Jakarta Selatan" />
                    <FooterItem title="021 - 1122 - 9090" href="tel: 02111229090" />
                  </ul>
                </div>
              </div>
            </div>
